...
| 项 | 状态 |
|----|------|
| Terminal 移至系统→高级设置下 | **CHANGED** — 左侧栏固定入口，无需勾选启用 |
| 常规保存导致 qosnatd 退出 | **FIXED** — 基本设置与 TLS 分开发送；TLS 仅在值变更时触发热切换 |

---

## 第十一轮（Web Terminal · v2026053109）

| 项 | 状态 |
|----|------|
| Terminal 需二次输密码 | **CHANGED** — 启用且已登录即可直连，移除 grant 弹窗与 `/terminal/grant` |
