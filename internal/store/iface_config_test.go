...
func TestIfaceConfigUpsertFindRemove(t *testing.T) {
	...
	up := true
	dhcp := false
	UpsertIfaceConfig(st, "ens18", []string{"10.0.0.1/24", "10.0.0.2/32"}, &up, &dhcp)
