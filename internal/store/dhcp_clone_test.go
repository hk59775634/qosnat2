...
func TestCloneDHCP(t *testing.T) {
	...
	src.StaticLeases = []DHCPStaticLease{{
	...
	src.StaticLeases[0].DNSServers[0] = "9.9.9.9"
	if cl.DNSServers[0] != "1.1.1.1" || cl.StaticLeases[0].IP != "192.168.1.50" || cl.StaticLeases[0].DNSServers[0] != "1.1.1.1" {
