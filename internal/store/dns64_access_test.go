...
func TestCollectDNS64AccessAllow(t *testing.T) {
	...
	st.VPN.WireGuards[0].Address = "198.19.0.1/24"
	st.VPN.OCServ.IPv4Network = "198.18.250.0"
...
func TestEffectiveUnboundListenDirect(t *testing.T) {
	...
	host, port, err := d.EffectiveUnboundListen("198.19.0.1")
	if err != nil || host != "198.19.0.1" || port != 53 {
