...
var Catalog = []Entry{
	...
	{Key: "net.ipv4.tcp_congestion_control", Category: "TCP", Description: "拥塞控制（长肥链路开启时由接口开关覆盖为 bbr）", Default: "cubic"},
	{Key: "net.ipv4.tcp_rmem", Category: "TCP", Description: "TCP 读缓冲 min/default/max", Default: "4096 131072 6291456"},
	{Key: "net.ipv4.tcp_wmem", Category: "TCP", Description: "TCP 写缓冲 min/default/max", Default: "4096 16384 4194304"},
	{Key: "net.core.default_qdisc", Category: "TCP", Description: "默认排队规则（长肥链路开启时覆盖为 fq）", Default: "fq_codel"},
	{Key: "net.ipv4.tcp_mtu_probing", Category: "TCP", Description: "TCP MTU 探测（长肥链路开启时为 1）", Default: "0"},
