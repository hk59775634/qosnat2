...
func (srv *Server) routes() {
	...
	m.HandleFunc("/api/v1/snmp/install", srv.requireAuth(srv.handleSNMPInstall))
	m.HandleFunc("/api/v1/snmp/service", srv.requireAuth(srv.handleSNMPService))
	m.HandleFunc("/api/v1/snmp/apply", srv.requireAuth(srv.handleSNMPApply))
	m.HandleFunc("/api/v1/snmp", srv.requireAuth(srv.handleSNMP))
	m.HandleFunc("/api/v1/routes/apply", srv.requireAuth(srv.handleRoutesApply))
	m.HandleFunc("/api/v1/frr/dynamic-routing/status", srv.requireAuth(srv.handleFRRDynamicRoutingStatus))
	m.HandleFunc("/api/v1/frr/dynamic-routing/apply", srv.requireAuth(srv.handleFRRDynamicRoutingApply))
	m.HandleFunc("/api/v1/frr/dynamic-routing", srv.requireAuth(srv.handleFRRDynamicRouting))
	m.HandleFunc("/api/v1/frr/install/status", srv.requireAuth(srv.handleFRRInstallStatus))
	m.HandleFunc("/api/v1/frr/install", srv.requireAuth(srv.handleFRRInstall))
	m.HandleFunc("/api/v1/frr/service", srv.requireAuth(srv.handleFRRService))
	m.HandleFunc("/api/v1/frr/config", srv.requireAuth(srv.handleFRRConfig))
	m.HandleFunc("/api/v1/frr/apply", srv.requireAuth(srv.handleFRRApply))
	m.HandleFunc("/api/v1/frr", srv.requireAuth(srv.handleFRR))
	...
	m.HandleFunc("/api/v1/firewall/presets/google-webrtc-block", srv.requireAuth(srv.handleFirewallPresetGoogleWebRTCBlock))
	...
	m.HandleFunc("/api/v1/firewall/aliases/refresh", srv.requireAuth(srv.handleFirewallAliasesRefresh))
